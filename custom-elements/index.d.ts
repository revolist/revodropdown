/* RevoDropdown custom elements bundle */
...
interface RevoListFilter extends Components.RevoListFilter, HTMLElement {}
export const RevoListFilter: {
  prototype: RevoListFilter;
  new (): RevoListFilter;
};
